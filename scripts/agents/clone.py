...
reference_path = "scripts/agents/input/david-c-cut-edited.wav"
...
def clone_voice_node(state):
    ...
    # reference_transcript = state["reference_transcript"]
    commentator_response = state["commentator_response"][-1]
    print(commentator_response)
    # BOSON_API_KEY = state["BOSON_API_KEY"]
    ...
    print("🎙️  Starting streaming voice cloning...")
