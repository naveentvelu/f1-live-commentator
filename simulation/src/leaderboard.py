...
class Leaderboard:
    ...
    def __init__(self, ordered_drivers: list[Driver], batch) -> None:
        ...
        self.ts = tuple(text.Label(driver.name_acronym, x=75, y=560 - i * 28, batch=self.batch, font_size=14, color=(255, 255, 255)) for i, driver in enumerate(reversed(self.ordered_drivers)))
