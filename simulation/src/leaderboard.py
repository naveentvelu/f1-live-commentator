...
class Leaderboard:
    ...
    def __init__(self, ordered_drivers: list[Driver], final_lap: int, batch) -> None:
        ...
        self.border = shapes.Rectangle(50, 8, 262, 616, batch=self.batch, color=(0, 0, 0, 25))
        self.title_border = shapes.Rectangle(120, 587, 118, 30, batch=self.batch, color=(0, 0, 0, 110))

        self.lap_title = text.Label(f"LAP {self.lap}/{self.final_lap}", x=180, y=595, batch=self.batch, font_size=16, color=(255, 255, 255), anchor_x="center")
